...
sess_options.optimized_model_filepath = "D:/UGit/ExtraNetTRTInference-main/optimized_model.onnx"

# ort_sess = ort.InferenceSession('GeneratedOnnx/FP16/ConvTest0-fp16-7.onnx', providers=['CPUExecutionProvider'])
ort_sess = ort.InferenceSession('D:/UGit/ExtraNetTRTInference-main/UNetGated_UEIntegrate_fp16.onnx', sess_options, providers=['CPUExecutionProvider'])
